...
**Căn cứ còn hiệu lực:** Điều/khoản · số hiệu · cơ quan
**Điểm đã sửa / bổ sung:** nếu context có VB chồng chéo; không có thì bỏ mục này
**Hiệu lực:** Còn hiệu lực / thay thế một phần / lưu ý ngày
**Phần kho chưa có:** nếu thiếu
**Nguồn:**
- [Loại VB số hiệu](URL)`;

const DEFAULT_ADVISE_TEMPLATE = `CẤU TRÚC TRẢ LỜI (Tư vấn thủ tục):
**Tóm tắt:** người dân / cán bộ cần làm gì (1–2 câu)
**Hồ sơ / giấy tờ:** gạch đầu dòng (chỉ những gì có trong context)
**Các bước:** đánh số
**Nơi nộp / thời hạn:** nếu có trong context; thiếu thì nói chưa có trong kho
**Lưu ý:** điểm dễ sai, điều kiện, hoặc điều khoản đã bị sửa
**Nguồn:**
- [Loại VB số hiệu](URL)`;
...
**Điểm giữ nguyên / đã sửa / đã bãi:** từng ý, có Điều/Khoản
...
function composeSystemPrompt(mode = 'lookup', voice = defaultVoice()) {
