...
export default function CitationChip({ href, children, className = '', status }) {
  ...
  const chipCls = `citation-chip inline-flex max-w-full items-center gap-1.5 rounded-full border border-[var(--hcc-gold)]/50 bg-[linear-gradient(135deg,#fff9e6,#fff8e8)] px-2.5 py-1 text-[13px] font-medium text-[#1a1214] no-underline shadow-sm align-middle ${className}`
