...
assert.equal(shouldCommitListen('hi', true), false)
assert.equal(shouldCommitListen('thủ tục cấp căn cước', true), true)
assert.equal(shouldCommitListen('thủ tục cấp căn cước', false), false)
